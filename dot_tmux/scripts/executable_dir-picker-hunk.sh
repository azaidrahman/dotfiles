...
#
# Keys:
#   Enter   go to the highlighted directory: cd the triggering pane there and
#           open `hunk diff` on it right here in this same popup (shows changes,
#           or an empty diff if the dir is clean — it's the "take me there and
#           show me" action).
...
# picked a directory you want to see it, even to confirm it's clean.
#
