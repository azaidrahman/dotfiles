...
| Lesson file name | `[L] <Topic> <DDMonYYYY>.md` |
...
4. Create the lessons folder if it does not exist. Create the lesson note `<Lessons folder>/[L] <Topic> <DDMonYYYY>.md`, for example `[L] Flannel 13May2026.md`. The `[L]` prefix marks the file as a lesson. The date is the file-name date from step 1. Write this frontmatter and nothing else:
