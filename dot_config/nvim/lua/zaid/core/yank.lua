-- GOT FROM https://xata.io/blog/configuring-neovim-coding-agents
-- https://github.com/richardgill/nix/blob/bdd30a0/modules/home-manager/dot-files/nvim/lua/custom/yank.lua
